import {InspectWorkloadModal, RegisterWorkloadModal, VisualizeWorkloadModal} from '@app/Components/Modals';
...
import { SessionTabsDataProvider } from '@app/Providers';
              ...
              >
                {workloads
                  ...
                  .map((workload: Workload, idx: number) => (
                    <DataListItem key={workload.id} id={workload.id} onClick={() => {
                                    ...
                                    <FlexItem>
                                      <Label>
                                        <Flex direction={{default: 'row'}}>
                                          ...
                                          <FlexItem>
                                            <Tooltip
                                              content="The current value of the internal workload/simulation clock.">
                                              <React.Fragment>
