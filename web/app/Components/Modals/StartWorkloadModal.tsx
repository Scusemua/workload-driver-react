...
export interface StartWorkloadModalProps {
    ...
    isOpen: boolean;
    onClose: () => void;
    onConfirm: (workloadTitle: string, preset: WorkloadPreset, workloadSeed: string) => void;
            ...
            actions={[
                <Button
                    ...
                    onClick={() => {
                        ...
                        props.onConfirm(workloadTitleToSubmit, selectedWorkloadPreset!, workloadSeed);
                    }}
        ...
        >
            <Form>
                        ...
                        <Popover
                            ...
                            bodyContent={
                                <div>
                                    ...
                                    help you identify the specific workload. Please note that the title must be between
                    ...
                    >
                        ...
                        >
                            <HelperTextItem
                                ...
                                label="workload-title-text-input-helper"
                            >
                                Provide a title to help you identify the workload. The title must be between 1 and 36
                ...
                >
                    ...
                    <FormHelperText
                        label="workload-data-dropdown-input-helper"
                        aria-label="workload-data-dropdown-input-helper"
                    >
                        <HelperText
                            label="workload-data-dropdown-input-helper"
                            aria-label="workload-data-dropdown-input-helper"
                        >
                            <HelperTextItem
                                ...
                                label="workload-data-dropdown-input-helper"
                            >
                                Select the workload preset, which largely determines which subset of trace data will be
                        ...
                        <Popover
                            ...
                            bodyContent={
                                <div>
                                    ...
                                    generator. You may leave this blank to refrain from seeding the random number
                                    generator. Please note that if you do specify a seed, then the value must be between
                                    0 and 2,147,483,647.
                                </div>
                            }
                        >
                    ...
                    >
                        ...
                        >
                            <HelperTextItem
                                ...
                                label="workload-seed-text-input-helper"
                            >
                                Provide an integer seed (between 0 and 2,147,483,647) for the workload's random number
                                generator, or leave blank to refrain from seeding the random number generator.
                            </HelperTextItem>
                        </HelperText>
                    </FormHelperText>
                </FormGroup>
